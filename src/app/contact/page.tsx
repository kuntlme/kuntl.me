    ...
    <div className="bg-zinc-900 flex flex-col min-h-screen">
      <section className="container mt-30">
        ...
        <div className="flex flex-col items-start gap-4 mb-8">
          <a href="mailto:kuntalmajee338@gmail.com" target="_blank" className="flex items-center gap-2 text-gray-300 hover:text-white transition">
          ...
          <a 
            ...
            className="flex justify-center items-center gap-2 text-gray-300 hover:text-white transition"
          >
