    ...
    <div className="bg-gray-200 dark:bg-zinc-900 flex flex-col">
      <section className="container mt-30">
        ...
        <div className="flex flex-col items-start gap-4 mb-8">
          <a href="mailto:kuntalmajee338@gmail.com" target="_blank" className="flex items-center gap-2 text-zinc-700 dark:text-gray-300 hover:text-green-600 dark:hover:text-cyan-400 duration-300">
          ...
          >
            ...
            <span className="text-sm text-gray-500 dark:text-gray-400 ml-2">•  Send me direct message and follow me for tech updates and development tips</span>
          </a>
          <a 
          ...
          >
            ...
            <span className="text-sm text-gray-500 dark:text-gray-400 ml-2">• Book a 30-minute call with me</span>
          </a>
        </div>
