        ...
        <div className="flex flex-col">
          <div className="flex border-l-2 border-green-600 dark:border-cyan-400 gap-1">
            ...
            <div className="flex flex-col mb-5 w-11/12">
              <h1 className="text-green-600 dark:text-cyan-400 text-2xl font-bold">2025</h1>
          ...
          <div className="flex border-l-2 border-green-600 dark:border-cyan-400 gap-1">
            ...
            <div className="flex flex-col mb-5 w-11/12">
              <h1 className="text-green-600 dark:text-cyan-400 text-2xl font-bold">2024</h1>
              <p className="text-zinc-700 dark:text-gray-300">
          ...
          <div className="flex border-l-2 border-green-600 dark:border-cyan-400 gap-1">
            <div className="relative -left-3 top-1 w-6 h-6 bg-green-600 dark:bg-cyan-400 rounded-full"></div>
            <div className="flex flex-col mb-5 w-11/12">
              <h1 className="text-green-600 dark:text-cyan-400 text-2xl font-bold">2023</h1>
              <p className="text-zinc-700 dark:text-gray-300">
          ...
          <div className="flex border-l-2 border-green-600 dark:border-cyan-400 gap-1">
            ...
            <div className="flex flex-col mb-1 w-11/12">
              <h1 className="text-green-600 dark:text-cyan-400 text-2xl font-bold">2022</h1>
              <p className="text-zinc-700 dark:text-gray-300">
