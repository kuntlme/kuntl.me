  ...
  return (
    <div className=''>
        ...
        <div className='flex justify-center items-center gap-2 text-zinc-300 my-10'>
          <Link href="/project" className='cursor-pointer text-zinc-700 dark:text-gray-100 hover:text-green-600 dark:hover:text-cyan-400 hover:scale-125 duration-300'>
