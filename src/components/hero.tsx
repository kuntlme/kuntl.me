    ...
    <div className="flex justify-between items-start pt-20">
      <div className="">
        ...
        <p className="text-md font-sans text-zinc-700 dark:text-zinc-400">
          As a <span className="text-green-600 dark:text-cyan-400 font-bold bg-gray-300 dark:bg-zinc-700 px-2 py-1">Full Stack</span> Developer building websites.
        </p>
        <br />
        ...
        <p className="text-md font-sans text-zinc-700 dark:text-zinc-400 mt-2">Find me on <a href="https://x.com/Kuntlmajee" target="_blank"><span className="text-green-600 dark:text-cyan-400 font-semibold cursor-pointer">twitter</span></a> for tech updates.</p>
      </div>
