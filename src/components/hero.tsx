  ...
  return (
    <div className="flex justify-between items-start pt-20">
      <div className="">
        ...
        <p className="text-md font-sans text-zinc-400 mt-2">Find me on <a href="https://x.com/Kuntlmajee" target="_blank"><span className="text-cyan-400 font-semibold cursor-pointer">twitter</span></a> for tech updates.</p>
      </div>
