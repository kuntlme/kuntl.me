...
const MarqueeStack = () => {
  ...
  return (
    <div className="w-full col-span-2 border border-slate-600 rounded-md p-4 flex justify-center items-center hover:border-cyan-400 hover:scale-105 duration-300">
