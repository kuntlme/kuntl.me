...
export const homeProjects: Project[] = [
    {
        id: 1,
        title: "Draw Together",
        description: "A collaborative drawing platform enabling real-time sketching and sharing with modern authentication and seamless user experience.",
        githubLink: "https://github.com/Kuntalmajee2557/excalidraw-project",
        direcLink: "",
        techStack: ["Turbo", "Postgres", "Prisma", "React", "Next.js", "Tailwind CSS", "TypeScript"],
    },
    {
        id: 2,
        title: "Link Saver",
        description: "A Link Saver website helps users store, organize, and manage web links efficiently, providing easy access, categorization, and bookmarking features.",
